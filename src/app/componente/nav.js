  ...
  return (
    <nav className=' bg-slate-100 flex p-2'>
      ...
      <ul className='flex flex-row flex-wrap gap-2'>
        ...
        <li><button className='text-center text-black bg-white px-3 py-1 rounded-3xl shadow-lg shadow-slate-400 transition ease-in-out delay-100 duration-75 hover:-translate-y-1 hover:scale-110' id='dark'>Oscoridad</button></li>
